...
const lowPopulationAnimals = [];
  zooAnimals.filter(function (names){
    if(names.population < 5){
    lowPopulationAnimals.push(names.animal_name)};
  });
...
*/
const populationTotal = zooAnimals.reduce(function(total, items){
